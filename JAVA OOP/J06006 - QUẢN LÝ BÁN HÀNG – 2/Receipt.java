public class Receipt {
    ...
    private long tienmua, tienban, soluong, tongtien, loinhuan;
    ...
    public void setLoiNhuan() {
        this.loinhuan = tongtien - soluong * tienmua;
    }
    ...
    public String toString() {
        return maHD + " " + tenKhach + " " + diachiKhach + " " + tenHang + " " + soluong + " " + tongtien + " " + loinhuan;
    }
}
